        ...
        try:
            ...
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    left_signs = self.obj_detection.detect(self.left_cascade, gray, image)
                    right_signs = self.obj_detection.detect(self.right_cascade, gray, image)

                    #distance measurement
                    if left_signs > 0:
                        d3 = self.d_to_camera.calculate(left_signs,self.h3,300,image)
                        self.d_direction_sign = d3
                    ...
                    elif 0 < self.d_direction_sign < 25:
                        if self.obj_detection.left_sign:
                            print("taking left")
                            self.rc_car.left()

                        self.d_direction_sign = 25
                        self.obj_detection.left_sign = False
...
if __name__ == '__main__':
    h, p1, p2 = "192.168.0.100", 10010, 8002
